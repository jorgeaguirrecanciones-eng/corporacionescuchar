const steps = [
  {
    icon: "⌾",
    paso: "Paso 1",
    title: "Eliges cuántos asientos abrir",
    desc: "Cada asiento vale $7.000",
  },
  {
    icon: "♡",
    paso: "Paso 2",
    title: "Tu aporte sostiene Círculos de Escucha gratuitos",
    desc: "Financias directamente los espacios donde ocurre la escucha.",
  },
  {
    icon: "◎",
    paso: "Paso 3",
    title: "Facilitamos espacios de encuentro y contención",
    desc: "Monitores formados facilitan círculos cada semana.",
  },
  {
    icon: "✉",
    paso: "Paso 4",
    title: "Al final del mes recibes los nombres de quienes participaron",
    desc: "Sabrás exactamente quién fue escuchado gracias a tu asiento.",
  },
];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-xl mx-auto text-center mb-14">
          ...
          <h2 className="font-heading text-3xl md:text-[2.6rem] text-verde leading-tight">
            Vive la experiencia de<br />regalar ser escuchado
          </h2>
        </div>
