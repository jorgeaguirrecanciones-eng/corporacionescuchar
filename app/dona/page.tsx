    ...
    <>
      ...
      <main className="min-h-screen bg-beige">
        <div className="max-w-lg mx-auto px-4 pt-4 pb-16">
          ...
          {step === 1 && (
            <div className="flex flex-col items-center">
              ...
              <div className="text-center mb-4">
                <div className="font-heading text-6xl font-bold text-verde leading-none tabular-nums">
                  {effectiveSeats}
                </div>
                <div className="text-verde/50 font-sans text-sm mt-0.5">
                  espacio{effectiveSeats !== 1 ? "s" : ""}
                </div>
                <div className="mt-2 text-terracota font-heading text-2xl font-bold leading-none">
                  {fmt(total)}
                </div>
              </div>
              ...
              <button
                onClick={() => goToStep(2)}
                className="w-full bg-terracota hover:bg-terracota-dark text-white font-sans font-semibold px-8 py-3 rounded-full transition-colors flex items-center justify-center gap-2 text-base shadow-lg shadow-terracota/20"
              >
          ...
          {step === 2 && (
            <div className="flex flex-col items-center">
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <div className="text-verde/60 font-sans text-sm leading-snug">
                        Tu espacio acompaña a alguien cada lunes, mes a mes. Puedes pausar o cancelar cuando quieras.
                      </div>
                      <div className="mt-3 text-terracota font-heading text-xl font-bold">
                        {fmt(total)}<span className="text-sm font-sans font-normal text-verde/45 ml-1">/ mes</span>
                      </div>
                    </div>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      ...
                      <div className="mt-3 text-terracota font-heading text-xl font-bold">
                        {fmt(total)}<span className="text-sm font-sans font-normal text-verde/45 ml-1">una vez</span>
                      </div>
                    </div>
              ...
              <div className="flex gap-3 w-full">
                <button onClick={() => goToStep(1)} className="flex items-center gap-1.5 text-verde/60 font-sans font-medium px-5 py-3 rounded-full border-2 border-verde/20 hover:border-verde/40 transition-colors">
                  <ArrowLeft size={16} />Volver
                </button>
                <button onClick={() => goToStep(3)} className="flex-1 bg-terracota hover:bg-terracota-dark text-white font-sans font-semibold px-8 py-3 rounded-full transition-colors flex items-center justify-center gap-2 shadow-lg shadow-terracota/20">
                  Continuar <ArrowRight size={18} />
                </button>
              </div>
            </div>
          ...
          {/* ══ PASO 3 — Datos + MP Brick (scroll permitido) ══ */}
          {step === 3 && (
            <div className="flex flex-col items-center">
              <span className="text-xs font-sans font-semibold tracking-widest text-terracota uppercase mb-2">
                Paso 3 de 3
              ...
              <div className="w-full space-y-3 mb-5">
                ...
                <div>
                  <label className="block text-sm font-sans font-medium text-verde mb-1">Nombre</label>
                ...
                <div>
                  <label className="block text-sm font-sans font-medium text-verde mb-1">Correo electrónico</label>
              ...
              <p className="text-verde/30 text-[11px] font-sans text-center mt-3">
