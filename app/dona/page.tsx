...
import { Gift, ArrowRight, ArrowLeft, Check, AlertCircle } from "lucide-react";
    ...
    <>
      ...
      <main className="min-h-screen bg-beige">
        <div className="max-w-lg mx-auto px-4 pt-10 pb-24">
            ...
            <div className="flex flex-col items-center">
              ...
              {showCustom && (
                <div className="flex items-center gap-4 mb-6 bg-white border-2 border-verde/20 rounded-2xl px-5 py-3">
                  <button
                    onClick={() => setCustomInput(String(Math.max(11, (parseInt(customInput) || 11) - 1)))}
                  ...
                  />
                  <button
                    onClick={() => setCustomInput(String((parseInt(customInput) || 0) + 1))}
                    className="w-9 h-9 rounded-full bg-verde/10 text-verde font-bold text-xl flex items-center justify-center hover:bg-verde/20 transition-colors"
                  >
                    +
                  </button>
              ...
              <div className="flex flex-col gap-4 w-full mb-10">
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 mt-0.5 transition-colors ${frequency === "monthly" ? "border-terracota bg-terracota" : "border-verde/25"}`}>
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      ...
                      <div className="mt-4 text-terracota font-heading text-2xl font-bold">
                        {fmt(total)}
                        <span className="text-sm font-sans font-normal text-verde/45 ml-1">una vez</span>
                      </div>
                    </div>
                    <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 mt-0.5 transition-colors ${frequency === "once" ? "border-terracota bg-terracota" : "border-verde/25"}`}>
          ...
          {/* ══════════════════════════════════════
              PASO 3 — Datos + Card Payment Brick
          ══════════════════════════════════════ */}
          {step === 3 && (
            <div className="flex flex-col items-center">
              <span className="text-xs font-sans font-semibold tracking-widest text-terracota uppercase mb-3">
              ...
              <div className="w-full space-y-4 mb-6">
                <div className="text-[10px] font-sans font-bold text-verde/40 uppercase tracking-widest">
                  Tus datos
                </div>
                <div>
              ...
              {/* Error message */}
              {brickError && (
                <div className="w-full mb-4 flex items-start gap-2 bg-red-50 border border-red-200 text-red-700 rounded-xl px-4 py-3 text-sm font-sans">
              ...
              {/* Paying overlay */}
              {paying && (
                <div className="w-full mb-4 flex items-center gap-2 bg-[#009EE3]/10 border border-[#009EE3]/20 text-[#007BBF] rounded-xl px-4 py-3 text-sm font-sans">
              ...
              <div className="w-full bg-white rounded-2xl p-6 shadow-sm border border-verde/10 mb-8 text-left">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-sans font-medium text-verde text-sm">
                      {frequency === "monthly" ? "Mensual" : "Donación única"}
                    </div>
                  </div>
                  <div>
